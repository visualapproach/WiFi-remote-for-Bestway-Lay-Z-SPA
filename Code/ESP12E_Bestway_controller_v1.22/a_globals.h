...
const char *OTAName = "BW-controller";           // A name and a password for the OTA service
...
volatile boolean chk1, chk2, chk3 = false;
...
bool newLog = true; //start new log after reboot (not used)
