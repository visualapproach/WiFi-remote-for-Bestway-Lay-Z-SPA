...
void startup() {
  ...
  //It will show up in the log file and the speaker may beep once in a while.
}
...
void startServer() { // Start a HTTP server with a file read handler and an upload handler
  server.on(F("/edit.html"),  HTTP_POST, []() {  // If a POST request is sent to the /edit.html address,
...
void setupDateTime() {
  ...
  DateTime.setTimeZone(2);            //hardcoded, DOH! :-) Change here if you live elsewhere
  DateTime.begin();
